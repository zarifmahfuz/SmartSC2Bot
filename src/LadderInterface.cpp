...
sc2::Difficulty LadderInterface::GetDifficultyFromString(const std::string &InDifficulty) {
...
sc2::Race LadderInterface::GetRaceFromString(const std::string &RaceIn) {
...
void LadderInterface::ParseArguments(int argc, char *argv[], ConnectionOptions &connect_options) {
    ...
    arg_parser.AddOptions({
                                  ...
                                  {"-r", "--realtime",           "Play game in real time"}
                          });
    ...
    std::string RealtimeStr;
    connect_options.Realtime = arg_parser.Get("realtime", RealtimeStr);
}

void LadderInterface::RunBot(int argc, char *argv[], sc2::Agent *Agent, sc2::Race race) {
